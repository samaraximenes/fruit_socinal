...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { carbohydrates: @fruit.carbohydrates, fat: @fruit.fat, name: @fruit.name, protein: @fruit.protein } }, as: :json
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { carbohydrates: @fruit.carbohydrates, fat: @fruit.fat, name: @fruit.name, protein: @fruit.protein } }, as: :json
    assert_response 200
  end
